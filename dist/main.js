  ...
  for (let i = 0; i < elements.length; i++) {
    if (i === 0) {
      ...
      for (let j = 0; j < rightSideBtns.length; j++) {
        ...
        if (j === 0) {
          button.addEventListener('click', (() => (0,_form_controller__WEBPACK_IMPORTED_MODULE_1__.showEdit)(button.dataset.taskId)))
        }
...
const createListItem = (task) => {
  ...
  for (let i = 0; i < elements.length; i++) {
    ...
    if (i === 0) {
      ...
      header.textContent = task.date ? (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.date, 'd MMM yyyy') : '';
...
const renderList = () => {
  const pendingTaskList = document.querySelector('#pending-task-list');
  const taskList = _tasks__WEBPACK_IMPORTED_MODULE_0__.taskMaster.read();
  clearList();
...
const createTask = () => {
  ...
  const newTask = (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.taskFactory)(taskId, taskName, taskDescription, date);
  _tasks__WEBPACK_IMPORTED_MODULE_0__.taskMaster.push(newTask);

  (0,_form_controller__WEBPACK_IMPORTED_MODULE_1__.hideMenu)('add-task');
  renderList();
};
...
const initializeButtonEvents = () => {
  ...
  cancelBtns.forEach((button) =>
    button.addEventListener('click', (e) => {
      (0,_form_controller__WEBPACK_IMPORTED_MODULE_1__.hideMenu)(e.target.dataset.menu);
    })
  );
};
...
const initializeUI = () => {
  ...
  (0,_form_controller__WEBPACK_IMPORTED_MODULE_1__.initializeForms)();
};
...
const getTaskInfo = (id) => {
  ...
  editDate.value = (!thisTask.date) ? '' : (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(thisTask.date, 'yyyy-MM-dd');
}
